(function () {
  ...
  ready(function () {
    ...
    function injectNavSearchIcon() {
      var nav = document.querySelector("nav.nav, nav");
      if (!nav) return;
      var container = nav.querySelector(".container") || nav;
      var link = document.createElement("a");
      link.href = "#";
      link.className = "bbg-nav-search";
      link.setAttribute("aria-label", "Search (Ctrl+K)");
      link.innerHTML = "&#128269;";
